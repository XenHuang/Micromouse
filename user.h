...
#define LEFTSENSORCORRECTION 26//negative
#define RIGHTSENSORCORRECTION 26
#define LEFTFRONTSENSORCORRECTION 35
#define RIGHTFRONTSENSORCORRECTION 35 //negative
