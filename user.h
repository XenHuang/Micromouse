...
#define LEFTSENSORCORRECTION 54 //negative
#define RIGHTSENSORCORRECTION 54
#define LEFTFRONTSENSORCORRECTION 29
#define RIGHTFRONTSENSORCORRECTION 29 //negative
