...
#define LEFTSENSORCORRECTION 39 //negative
#define RIGHTSENSORCORRECTION 39
#define LEFTFRONTSENSORCORRECTION 71
#define RIGHTFRONTSENSORCORRECTION 71 //negative
