...
#define LEFTSENSORCORRECTION 22 //negative
#define RIGHTSENSORCORRECTION 23
#define LEFTFRONTSENSORCORRECTION 17
#define RIGHTFRONTSENSORCORRECTION 17 //negative
